...
class Articles{// Since it has a pure virtual function , it is an abstract BASE class
    protected:
        string name;
        int rating;
    public:
        ...
        virtual void show() = 0; // pure virtual function / do nothing function / abstract function
        // This needs to be defined in derived classes (any class that derives this class)
};
